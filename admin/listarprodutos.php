...
<body> 
    <a  href="produto.php" style="color: black; position: relative; left: 70px; ">
    ...
    <table border="2" style=" position: relative; left: 3%;  border-spacing: 5px; top: 20px; " id="tabela">
        ...
        <tr>
            ...
            <td >    
                <a href="editpro.php?codigo=<?php echo $dado["PRODUTO_CODIGO"]; ?>"  style="color: black; ">
                    <button style="  background-color: lightblue; font-size: 18px; ">
                    Editar
                    </button>
                </a>
                <a href="pro_excluir.php?codigo=<?php echo $dado["PRODUTO_CODIGO"]; ?>" style="color: black; ">
                    <button href="usu_editar.php?codigo=<?php echo $dado["PRODUTO_CODIGO"]; ?>" style=" background-color: red; font-size: 18px; ">Excluir</button>
                </a>
            </td>
        </tr>
        <?php } ?>
